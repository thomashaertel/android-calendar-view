...
public class Cell {
    ...
    public Cell(int dayOfMon, Rect rect, float textSize, boolean bold, int color) {
    ...
    public Cell(int dayOfMon, Rect rect, float textSize, boolean bold) {
        this(dayOfMon, rect, textSize, bold, Color.BLACK);
    }

    public Cell(int dayOfMon, Rect rect, float textSize) {
        this(dayOfMon, rect, textSize, false, Color.BLACK);
    }

    public Cell(int dayOfMon, Rect rect, float textSize, int color) {
        this(dayOfMon, rect, textSize, false, color);
    }
